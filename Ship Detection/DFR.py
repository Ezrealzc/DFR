...
class DFRNet(object):
    ...
    def generate(self):
        ...
        #   创建DFR模型
        #----------------------------------------#
        self.DFR = DFR([self.input_shape[0], self.input_shape[1], 3], num_classes=self.num_classes, backbone=self.backbone, mode='predict' if not self.heatmap else 'heatmap')
