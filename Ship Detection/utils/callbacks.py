...
class EvalCallback(keras.callbacks.Callback):
    def __init__(self, model_body, input_shape, class_names, num_classes, val_lines, log_dir,\
            map_out_path=".temp_map_out", max_boxes=200, confidence=0.05, nms=True, nms_iou=0.5, letterbox_image=True, MINOVERLAP=0.5, eval_flag=True, period=1):
    ...
    def get_map_txt(self, image_id, image, class_names, map_out_path):
        ...
        outputs    = self.model_body.predict(image_data)
        #--------------------------------------------------------------------------------------------#
